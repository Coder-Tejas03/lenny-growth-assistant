...
A separate reranker is **not required initially**.

For this corpus size, first establish a strong pgvector baseline. Add reranking only if evaluation shows that semantic retrieval is insufficient.
