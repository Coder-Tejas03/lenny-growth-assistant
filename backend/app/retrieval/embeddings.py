"""
Lenny Growth Assistant — Backend Embedding Client & Cost Telemetry

Self-contained module for 1536-dimensional vector embedding generation using OpenAI's
text-embedding-3-small model, with request batching, rate-limit retries, cost tracking,
budget guardrails, and deterministic offline mock capabilities.
"""
